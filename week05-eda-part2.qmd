...
-   Box: Shows the **interquartile range (IQR)** — the middle 50% of the data (from the 25th percentile/Q1 to the 75th percentile/Q3).

-   Whiskers: Usually extend to the smallest and largest data points within **1.5 × IQR** from the box. They represent the "typical" range of the data.

-   Dots: Values that fall outside of whiskers, outliers
